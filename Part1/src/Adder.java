	...
	public void run() {
		while ("the truth about forever is that it is hapenning right now" != null) {
			try {
				...
				System.out.println("I am goint to send a new data in 7 sec...");
				Thread.currentThread().sleep(7000);
			} catch (InterruptedException ex) {
				System.out.println(System.currentTimeMillis() - data.get_StartTime() + " [" + Thread.currentThread().getName() + "]" + " INFO Adder -  Stopping sending new data...");
				break;
			}
		}
	}
